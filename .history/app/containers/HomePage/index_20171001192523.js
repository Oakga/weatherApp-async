...
import { makeSelectTodayWeather, makeSelectGeoLocationAddress, makeSelectLoading, makeSelectError } from 'containers/App/selectors';
...
export class HomePage extends React.PureComponent { // eslint-disable-line react/prefer-stateless-function
  ...
  render() {
    ...
    let todayWeather = this.props;
    const weather = todayWeather.toJS();
    console.log(weather);
