...
import { AtPrefix, CenteredSection, Form, Input, Section } from './styles/index';

export class HomePage extends React.PureComponent { // eslint-disable-line react/prefer-stateless-function
  /**
   * when initial state search location is not null, submit the form to call geo location api
   */
  componentDidMount() {
