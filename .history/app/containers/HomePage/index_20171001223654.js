...
export class HomePage extends React.PureComponent { // eslint-disable-line react/prefer-stateless-function
  ...
  shouldComponentUpdate(nextProps) {
    const differentFilterData = this.props.filteredData !== nextProps.filteredData;
    if (differentFilterData) this.updateChart(this.props.filteredData, this.props.label);
  }
