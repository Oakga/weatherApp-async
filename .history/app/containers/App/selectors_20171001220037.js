...
const makeSelectWeeklyWeatherFilteredLabel = () => createSelector(
  selectGlobal,
  (globalState) => {
    const state = globalState.getIn(['weeklyWeather', 'filteredLabel']);
    return state,
  }
);
...
export {
  ...
  makeSelectWeeklyWeatherFilteredLabel,
